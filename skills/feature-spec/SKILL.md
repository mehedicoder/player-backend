...
- Artifact placement rule: list feature-specific files and confirm they are stored under `specs/YYYY-MM-DD-<feature-name>/`
...
- Keep all feature-specific documents, checklists, and implementation notes within the active feature-spec folder
